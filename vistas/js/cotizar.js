$(document).ready(function () {
  ...
  function consulPlaca() {
    ...
    if(tipoDocumentoID == "2"){
        var restriccion = '';
        if(rolAsesor == 19){
          restriccion = 'Lo sentimos, no puedes realizar cotizaciones para personas jurídicas por este cotizador. Para hacerlo cotiza como persona natural con los datos del representante legal o comunicate con el Equipo de Asesores Freelance de Grupo Asistencia, quienes podrán ayudarte a cotizar de manera manual con diferentes aseguradoras.';
        }else{
          restriccion = 'Lo sentimos, no puedes realizar cotizaciones para personas jurídicas (con NIT) por este cotizador. Cotiza como persona natural con los datos del representante legal.'
        }
        Swal.fire({
          icon: 'error',
          text: restriccion,
  ...
  const mostrarOferta = (
    ...
    let cardCotizacion = `
                   ...
                   <div class='col-12' style='margin-top:2%;'>
                      ${((aseguradora == "Liberty" || aseguradora == "Equidad" || aseguradora == "Mapfre" || aseguradora == "Seguros Bolivar") && id_intermediario == "78") ?
                        `<center>
          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              if(intermediario != 78){
                  ...
                  const aseguradoras_sin_convenio = ['Allianz', 'Liberty', 'Previsora', 'SBS', 'Zurich', 'HDI'];
                  aseguradoras_sin_convenio.forEach(entidad => {
                     mostrarAlertarCotizacionFallida(entidad, "Entidad sin convenio con el intermediario");
                  })
